...
const buttonVariants = cva(
  "gap-x-2 active:scale-95 disabled:cursor-not-allowed inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 dark:hover:bg-neutral-800 disabled:opacity-50 dark:focus:ring-neutral-400 dark:focus:ring-offset-neutral-900 data-[state=open]:bg-neutral-100 dark:data-[state=open]:bg-neutral-800",
  {
    variants: {
      variant: {
        default:
